 ...
 */
final class Version20200702163620 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT NOT NULL, product_id INT NOT NULL, name VARCHAR(255) NOT NULL, xml_id VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, unit VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_29D6873E4584665A ON offer (product_id)');
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, vendor VARCHAR(255) DEFAULT NULL, vat_rate DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE section (id INT NOT NULL, name VARCHAR(255) NOT NULL, pictures TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN section.pictures IS \'(DC2Type:array)\'');
